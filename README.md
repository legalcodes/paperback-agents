...
- **Never creates, rotates, or deletes.** The plugin never mints a share link, never creates or rotates or deletes a live doc or its edit link, and never uploads a *new* document (the live-doc write verb sends markdown only into a doc a human already made live and handed over). Creating and sharing stay human, in-app actions, by design: agents render and edit what they're handed, humans publish.
